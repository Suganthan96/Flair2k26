...
export default function Footer() {
  return (
    <footer id="contact" className="relative overflow-hidden border-t border-white/10 px-6 pt-8">
      {/* Background Video */}
      <video
        autoPlay
        loop
      ...
      >
        <source src="/assets/footer_video.mp4" type="video/mp4" />
      </video>

      {/* Gradient overlay for readability */}
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black via-black/85 to-black/70" />

      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-[1.2fr_1.2fr_1.3fr_0.9fr]">
        <div>
      ...
      <div className="relative z-10 mx-auto mt-12 max-w-7xl border-t border-white/10 pt-6 text-center text-xs text-white/40">
      ...
      <div
        aria-hidden
        className="pointer-events-none relative z-10 -mx-6 mt-8 select-none whitespace-nowrap text-center font-avenger uppercase leading-none text-white/5 text-[18vw]"
      >
        FLAIR2K26
      </div>
    </footer>
