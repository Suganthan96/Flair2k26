...
export default function EventDetailModal({
  ...
  return (
    <>
                ...
                <div className="mt-4 flex flex-wrap items-center gap-3">
                  ...
                  {event.guidelinesPdf && (
                    <button
                      ...
                      className="rounded-full border border-white/20 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-white/80 transition-colors hover:border-white/40 hover:text-white"
                    >
                      Guidelines
                    </button>
                  )}
      ...
      {showGuidelines && event.guidelinesPdf && (
        <GuidelinesModal
          pdfUrl={event.guidelinesPdf}
